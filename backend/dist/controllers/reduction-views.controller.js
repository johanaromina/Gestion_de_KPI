 ...
 */
export const getReductionKPIs = async (req, res) => {
    try {
    ...
    `;
        ...
        if (Array.isArray(rows)) {
            ...
            Object.values(grouped).forEach((group) => {
                group.evolution.sort((a, b) => new Date(a.periodStartDate).getTime() -
 ...
 */
export const getReductionStatistics = async (req, res) => {
    try {
    ...
    `;
        ...
        const statistics = Array.isArray(rows)
            ? rows.map((row) => ({
                ...
                completionRate: (parseInt(row.completedCount) /
 ...
 */
export const getReductionEvolution = async (req, res) => {
    try {
...
//# sourceMappingURL=reduction-views.controller.js.map