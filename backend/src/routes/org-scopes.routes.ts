...
import { listOrgScopes, createOrgScope, updateOrgScope, deleteOrgScope, deleteOrgScopeCascade, importOrgScopes } from '../controllers/org-scopes.controller'
...
router.delete('/:id/cascade', requirePermission('config.manage'), deleteOrgScopeCascade)
