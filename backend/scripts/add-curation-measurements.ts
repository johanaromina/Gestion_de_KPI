...
async function addCurationAndMeasurements() {
  ...
  try {
    ...
    const scriptPath = join(__dirname, 'add-curation-measurements.sql')
    const sqlScript = readFileSync(scriptPath, 'utf-8')

    console.log('🔧 Ejecutando script de curaduria y mediciones...')
    ...
    console.log('✅ Curaduria y mediciones agregadas/verificadas')
  } catch (error: any) {
