...
async function addAuthColumns() {
  ...
  try {
    ...
    const scriptPath = join(__dirname, 'add-auth-columns.sql')
    const sqlScript = readFileSync(scriptPath, 'utf-8')

    console.log('🔧 Ejecutando script de columnas de autenticacion...')
    ...
    console.log('✅ Columnas de autenticacion agregadas/verificadas')
  } catch (error: any) {
