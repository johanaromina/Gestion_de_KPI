...
async function addCollaboratorsOrgScope() {
  ...
  try {
    ...
    const scriptPath = join(__dirname, 'add-collaborators-orgscope.sql')
    const sqlScript = readFileSync(scriptPath, 'utf-8')

    console.log('🔧 Ejecutando script de orgScope en colaboradores...')
    ...
    console.log('✅ Org scopes vinculados a colaboradores')
  } catch (error: any) {
